...
public class Requests {
    ...
    public Requests(String bloodname, int quantity, int quantity_fulfilled, String status){
    ...
    public Requests(int id, int userId, int bloodId, int quantity, int quantity_fulfilled, String status) {
        this.id       = id;
        this.userId   = userId;
